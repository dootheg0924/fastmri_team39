...
| 007 | Final FI-VarNet (`6+6`) + MRAugment, train+val | Calibration required | [`experiments/007_fivarnet_mraugment`](experiments/007_fivarnet_mraugment) |
...
The final submission workflow is experiment 007. It first runs a disposable
two-epoch throughput calibration, then trains a new deterministic scratch
model with one fixed epoch horizon. See the experiment README before launch.
